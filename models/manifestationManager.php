...
class manifestationManager
{
    ...
    {
        $q = $this->_db->prepare('INSERT INTO Manifestations (name,city,department,country,address,start,end,type ,schedule,site,price,exhibitorNumber,exhibitorPrice,organiser) VALUES(:name,:city,:country,:dept,:add,:start,:end,:type,:schedule,:site,:price,:exNumb,:exPrice,:organiser) ');
        ...
        $q->bindValue(':country', $m->getCountry(), PDO::PARAM_STR);
    ...
    {
        $q = $this->_db->prepare('UPDATE Manifestations SET name= :name ,city= :city,department = :dept,country = :country,address = :add,start = :start,end = :end ,type = :type,schedule = :schedule,site = :site,price = :price,exhibitorNumber = :exNumb,exhibitorPrice = :exPrice,organiser = :organiser WHERE id = :id');
